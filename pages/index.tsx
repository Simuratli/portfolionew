...
export default function Home() {
  return (
    <div className={styles.container}>
      ...
      <GrayBox>
        <p>
          I am a Front-end developer with 4 years of experience. Interested in
          the entire Front-end spectrum and working on ambitious projects with
          positive people. Able to effectively self-manage during independent
          projects, as well as collaborate as part of a productive team.
        </p>
        <br />
        <ul className={classes.graybox__list}>
          <li>
            Building stable and maintainable web applications (SPA) using
            React,js{' '}
          </li>
          <li>
            Web page development from design to test and up to production
            deployment.
          </li>
