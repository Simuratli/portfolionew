    ...
    <div className={classes.books}>
      ...
      <div className={classes.books__content}>
        <Toggle header='Fyodor Dostoevsky'>
          ...
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nesciunt fugit quasi eius
            repellendus tenetur veniam illo ipsa amet aspernatur quae obcaecati, id odio aliquid
            impedit, expedita quis voluptate animi facere.
          </p>
        </Toggle>
      </div>
    </div>
