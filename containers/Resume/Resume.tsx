...
function Resume() {
  ...
  return (
    <div className={classes.resume}>
      ...
      <ResumeItem
        title={"📄 Full Name"}
        badge={aboutState.name}
        color={"rgba(105, 64, 165, 0.3)"}
      />
      <ResumeItem
        title={"🌌 Age"}
        badge={aboutState.age}
        color={"rgba(143, 142, 138, 0.5)"}
      />
      <ResumeItem
        title={"⚗️ Experience"}
        badge={aboutState.experience}
        color={"rgba(184, 70, 63, 0.3)"}
      />
      <ResumeItem
        title={"🏬 Work place"}
        badge={aboutState.workPlace}
        color={"rgba(11, 110, 153, 0.3)"}
      />
      <ResumeItem
        title={"🔍 Title"}
        badge={aboutState.title}
        color={"rgba(223, 172, 3, 0.3)"}
      />
      <ResumeItem
        title={"📘 Currently Learning"}
        badge={aboutState.currentlyLearning}
        color={"rgba(105, 64, 165, 0.3"}
      />
    </div>
  );
