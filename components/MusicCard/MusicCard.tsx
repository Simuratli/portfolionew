    ...
    <div onClick={onClickPlay} className={classes.musicCard}>
      <div className={classes.musicCard__image}>
        <button className={classes.musicCard__icon}>
          {musicPlayer.isPlaying ? (musicPlayer.name.includes(name) ? <AiOutlinePauseCircle /> : <AiOutlinePlayCircle />) : <AiOutlinePlayCircle />}
        </button>
      ...
      <div>
        {musicPlayer.name.includes(name) && <span className={classes.musicCard__active__dot}></span>}
      </div>
    </div>
  )
}
