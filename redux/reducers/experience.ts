...
const experienceReducer = createSlice({
  ...
  initialState: {
    data: [
      ...
      },
      {
        ...
        description:
          "Here I have mainly developed e-commerce projects and made support for available apps. And also teach students how to become a front-end developer.",
      },
      {
        id: 2,
        title: "Frontend developer",
        ...
        description:
          "When I work freelance in Baku I made different websites for different costumers. For example, I made a website for a big ship company in   Baku Techmarine LTD. And also I have side projects for the Data Development course called DataStat and I made a website for big Wallpaper  holding a TVB group.",
      },
    ],
  ...
  reducers: {
    ...
    setChangeExperienceValue: (state: ExperienceStateType, action) => {
      ...
      const newState: ExperienceDataObjectType[] = currentState.data.map(
        (exp) => {
...
export const { setExperience, setAddNewExperience, setChangeExperienceValue } =
